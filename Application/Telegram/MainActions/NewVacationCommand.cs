        ...
        public static async Task Handle(Update update, TelegramBotClient telegramBotClient, IMediator mediator)
        {
            ...
            switch (UserStateStorage.GetUserCurrentState(update.CallbackQuery.From.Id))
            {
                case UserState.NewVacationIsSelected:
                    await new SendMonthCommand(mediator, telegramBotClient).Send(update.CallbackQuery, "Please select start date month", "BACKStartingProcess");
                ...
                case UserState.NewVacationIsSelectedStartDateMonth:
                    ...
                    await new SendDayCommand(mediator, telegramBotClient).Send(update.CallbackQuery, "Please select start date day", "BACKStartingProcess");
                ...
                case UserState.NewVacationIsSelectedStartDateDay:
                    ...
                    await new SendMonthCommand(mediator, telegramBotClient).Send(update.CallbackQuery, "Please select end date month", "BACKStartingProcess");
                ...
                case UserState.NewVacationIsSelectedEndDateMonth:
                    ...
                    await new SendDayCommand(mediator, telegramBotClient).Send(update.CallbackQuery, "Please select end date day", "BACKStartingProcess");
